...
#include "E:/IndustrialDebugger/src/Network/UdpClient.h"
...
QT_MOC_LITERAL(6, 49, 11) // "onReadyRead"

    },
    "UdpClient\0dataReceived\0\0data\0errorOccurred\0"
    "error\0onReadyRead"
};
...
void UdpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (UdpClient::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpClient::dataReceived)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpClient::errorOccurred)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void UdpClient::dataReceived(const QByteArray & _t1)
{
