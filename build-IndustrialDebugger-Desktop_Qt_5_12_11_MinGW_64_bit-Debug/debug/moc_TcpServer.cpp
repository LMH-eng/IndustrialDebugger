...
#include "E:/IndustrialDebugger/src/Network/TcpServer.h"
...
QT_MOC_LITERAL(6, 49, 15), // "onNewConnection"
QT_MOC_LITERAL(7, 65, 11), // "onReadyRead"
QT_MOC_LITERAL(8, 77, 20) // "onClientDisconnected"

    },
    "TcpServer\0dataReceived\0\0data\0errorOccurred\0"
    "error\0onNewConnection\0onReadyRead\0"
...
void TcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpServer::errorOccurred)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TcpServer::dataReceived(const QByteArray & _t1)
{
